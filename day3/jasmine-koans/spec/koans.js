...
describe("the JavaScript language", function(){
  ...
  describe("has different types and operators that", function(){
    ...
    it("considers an empty string to be falsy", function(){
        expect("" == false).toBeTruthy(true);// Truthy or Falsy
        expect("" === false).toBeFalsy(false);// Truthy or Falsy
    });
  ...
  describe("considers functions as first class citizens", function(){
    ...
    it("may return arrays that contains functions and so on", function(){
        function example(){
           ...
           return [function(a){    /*la letra "a" es un parametro*/
                 return [0, 5 * 2];
           }];
        }
    ...
    it("anonymous functions are anonymous", function(){
         ...
         expect(typeof(z)).toEqual("undefined"); /*cuando asignamos una funcion NO PUEDE TENER NOMBRE por eso esto es indefinido*/
         expect(x()).toEqual(1);
    });
  ...
  describe("has multiple ways to define and create objects", function(){
    ...
    it("may create objects also with the module pattern", function(){
        ...
        var varobject = {                                                      /*here*/
             ...
             return {
                incrementScoreIn: function(){varobject.points + initialScore;},
                score: function(){ return varobject.points;}
             };
        }
